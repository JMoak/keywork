...
| 12 | Zero states & onboarding choreography | **Parked**; discuss/choreograph later | none |
...
**motion lives in ink, never in geometry** (layout snaps because rects are truth, per
...
demo scenes (hero frames such as startup key-turn, gradient sweep, garden heat emerge
